...
public class CascadeFatherAdapter_GetInfo extends BaseAdapter 
{
	...
	private List<KeshiInfo> items=null;
	...
	public CascadeFatherAdapter_GetInfo(Context context,List<KeshiInfo> bigclass,int[] images)
	{
		this.context = context;
		this.items = new ArrayList<KeshiInfo>();
		this.items.addAll(bigclass);
		this.images = images;
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		listitem_title.setText(items.get(position).getKeshiname());
